...
def location_exploration(char_sheet, location, creatures, boss):
    ...
    while exploration_counter < location_length and char_sheet[4] > 0:
        ...
        if if_fight > 50:
            ...
            if not exploration_player_actions(char_sheet):
...
def exploration_player_actions(char_sheet):

    player_choice = None
    chose_to_leave = False
    took_action = True
    ...
    while player_choice not in [1, 2, 3, 4, 5] and char_sheet[4] > 0:
    ...
    return chose_to_leave, took_action
